...
import 'package:media_house_all/model/myaudio.dart';
import 'package:media_house_all/playerControls.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  double _value = 2;
  Map audioData = {
    'image': 'https://www.svgrepo.com/download/293355/music.svg',
    'url':'https://s4.radio.co/sb70496db1/listen'
  };
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Column(
                children: [
                  SliderTheme(
                    data: SliderThemeData(trackHeight: 5, thumbShape: RoundSliderThumbShape(enabledThumbRadius: 5)),
